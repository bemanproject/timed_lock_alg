...
**10** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Preconditions*: Each template parameter type meets the *Cpp17TimedLockable* requirements.

**11** &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*Effects*: Equivalent to:<br>`return try_lock_until(chrono::steady_clock::now() + rel_time, ls...);`
